...
const ShopperLocationPinIcon = ({
  ...
  return filled ? (
    <svg
      ...
      viewBox="0 0 256 256"
      xmlSpace="preserve"
      className={handles.shopperLocationPinIconSVG}
    >
      <defs />
      <g
      ...
      >
        <path
          ...
          strokeLinecap="round"
          className={handles.shopperLocationPinIconPath}
        />
      </g>
    </svg>
  ) : (
...
export default ShopperLocationPinIcon
