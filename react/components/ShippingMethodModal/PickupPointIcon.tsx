...
const CSS_HANDLES = ['pickupPointIconPath', 'pickupPointIconSVG'] as const

const PickupPointIcon = ({ width = 34, height = 34 }: Props) => {
  ...
  return (
    <svg
      ...
      viewBox="0 0 34 34"
      fill="none"
      className={handles.pickupPointIconSVG}
    >
      <path
        ...
        className={handles.pickupPointIconPath}
      />
      <path
        d="M29 21V33H5V21"
        stroke="#3F3F40"
...
export default PickupPointIcon
